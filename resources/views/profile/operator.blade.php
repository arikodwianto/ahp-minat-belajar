...
<section class="content-header">
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <h1 class="fw-bold"><i class="bi bi-person-badge me-2"></i> Profil Operator</h1>
            <ol class="breadcrumb float-sm-end mb-0">
                <li class="breadcrumb-item"><a href="{{ route('operator.dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item active">Profil Operator</li>
            </ol>
        </div>
    </div>
</section>
                ...
                <div class="card card-outline card-primary shadow-sm">
                    ...
                    <form method="POST" action="{{ route('operator.profile.update') }}">
                        ...
                        <div class="card-footer text-end">
                            <a href="{{ route('operator.dashboard') }}" class="btn btn-outline-secondary me-2">
