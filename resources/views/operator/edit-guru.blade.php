    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h3 class="mb-0">Edit User Guru</h3>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow-lg border-0 rounded-3">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0"><i class="bi bi-pencil-square me-2"></i> Form Edit Guru</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('operator.guru.update', $guru->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name', $guru->name) }}" required>
                        </div>
