    ...
    <div class="card-body">
        <form action="{{ route('operator.siswa.update', $siswa->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="agama" class="form-control" value="{{ old('agama', $siswa->agama) }}" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="tahun_masuk" class="form-control" value="{{ old('tahun_masuk', $siswa->tahun_masuk) }}">
            </div>
            <div class="mb-3">
